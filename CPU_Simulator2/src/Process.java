...
public class Process {
	...
	public Process(double _timeStamp, int processid, double _nextProcessCreateTime, double processLength, boolean _processType, Double currentBurst) {
		timeStamp = _timeStamp;
		pid = processid;
		nextProcessCreateTime = _nextProcessCreateTime;
		CPU_Time = processLength;
