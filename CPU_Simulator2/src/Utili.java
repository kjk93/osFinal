 ...
 */
	...
	public static boolean scanFile(Scanner scanner){
		...
		if(scanner!=null){
			...
			scanner.nextLine();
			avgProcessLength = scanner.nextInt()/1000000;
			scanner.nextLine();
			creationMean = scanner.nextInt()/1000000;
			scanner.nextLine();
	...
	public static double getprocessLength(){
		return format(exponential(avgProcessLength));
	}
	//create service time
	public static double getioServiceTime(){
		return format(exponential(i_oServTime)/1000000);
	}
	
	//create next process 
	public static double nextCreationTime(){
		return format(Clock.getCurrentTime() + exponential(creationMean));
	}
	...
	public static double format(double nice){
		nice *= 10000;
	    nice = (int) nice;
	    nice /= 10000;
	    return nice;
	...
	public static double firstBurstLength(boolean isIO_Bound){
		Random rand = new Random();
		if(isIO_Bound){
			return format(((double)(rand.nextInt(2000)+2000)/1000000));
		}else{
		return format(((double)(rand.nextInt(10000)+10000))/1000000);
		}
	}
